...
public static class EpisodeQueries
{
    ...
    public static Episode? GetByAnimeSlugAndNumber(this DbSet<Episode> episodes, string animeSlug, int number) => episodes.SingleOrDefault(episode => episode.Anime.Slug == animeSlug && episode.Number == number);
