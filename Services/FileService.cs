...
public class FileService : IFileService
{
    ...
    private async Task<Response<BlobDownloadStreamingResult>> Download(string blob)
    {
        return await _blobServiceClient.GetBlobContainerClient(BlobContainerName).GetBlobClient(blob).DownloadStreamingAsync();
    }
